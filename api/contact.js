...
export default async function handler(req, res) {
  try {
    ...
    const from = process.env.CONTACT_FROM_EMAIL= "Consulta desde Página Web  <onboarding@resend.dev>"; // ej: "Neo Translations <onboarding@resend.dev>" o tu dominio verificado
